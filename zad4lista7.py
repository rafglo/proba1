...
print("Początkowa ilość paliwa w rakietach: "+ str(rakiety_nowe[0].paliwo))
    ...
    if ktora_rakieta == 'stop':
        ...
        if 1 <= int(ktora_rakieta) <= 5:
            ...
            while not(-10 <= rakiety_nowe[int(ktora_rakieta) - 1].x + dx <= 10 and -10 <= rakiety_nowe[int(ktora_rakieta) - 1].y + dy <= 10):
                ...
                if rakiety_nowe[int(ktora_rakieta) - 1].paliwo - math.sqrt(dx**2 + dy**2) < 0:
                    print("W rakiecie nr " + str(ktora_rakieta) + " nie ma wystarczającej ilości paliwa, by przelecieć podaną odległość.")
                else:
                    ...
                    print("3 -> 5 : " + str(rakiety_nowe[2].get_distance(rakiety_nowe[4])[0]))
                    print("4 -> 5 : " + str(rakiety_nowe[3].get_distance(rakiety_nowe[4])[0]))
                    print("Ilość paliwa w rakiecie 1: " + str(rakiety_nowe[0].paliwo))
                    print("Ilość paliwa w rakiecie 2: " + str(rakiety_nowe[1].paliwo))
                    print("Ilość paliwa w rakiecie 3: " + str(rakiety_nowe[2].paliwo))
                    print("Ilość paliwa w rakiecie 4: " + str(rakiety_nowe[3].paliwo))
                    print("Ilość paliwa w rakiecie 5: " + str(rakiety_nowe[4].paliwo))
